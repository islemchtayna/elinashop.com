// ضع هنا كل البلديات التي لديك بنفس التنسيق
const RAW_DATA = [
  {
    id: 22,
...
// محرك التحويل التلقائي (يعمل مرة واحدة عند التحميل)
const LOCAL_LOCATIONS = {};
RAW_DATA.forEach((item) => {
  const wName = item.wilaya_name;
  if (!LOCAL_LOCATIONS[wName]) {
    LOCAL_LOCATIONS[wName] = {
      name_fr: item.wilaya_name_ascii,
      code: item.wilaya_code.toString().padStart(2, "0"),
      communes: [],
    };
  }
  LOCAL_LOCATIONS[wName].communes.push({
